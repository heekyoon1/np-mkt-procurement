...
function bindEvents() {
  ...
  document.querySelector("#roleSelect")?.addEventListener("change", (e) => { state.role = e.target.value; render(); });
...
render = function () {
  ...
  const leadOption = document.querySelector("#roleSelect option[value='lead']");
  if (leadOption) leadOption.textContent = `${roles.lead.label} · ${roles.lead.name}`;
